...
async def analyze_voice_auto(
    ...
    try:
        ...
        if force_engine:
            ...
            detection_result = {"environment": engine_type, "confidence": 1.0, "reason": "사용자 지정"}
        else:
        ...
        youtube_videos = []
        try:
            youtube_videos = youtube_service.get_recommended_videos(result['scores'], max_results=6)
